...
#define KEY_ALL				0xFFFFFFFF
	...
	#define ID_EDIT_PASTE_TO_POSITION	ID_EDIT_GROUP + 2
#endif
...
public:
	...
	void	SetPastePosition( const CPoint& pos );
	CPoint	GetPastePosition() const;
	...
	virtual void		Undo();
	virtual void		Redo();
	virtual void		PasteToPosition( const CPoint& pos );
...
protected:
	...
	afx_msg void OnEditPasteToPosition();
...
private:
	...
	// This is the submode selected object
	CDiagramEntity*	m_subModeSelected;
